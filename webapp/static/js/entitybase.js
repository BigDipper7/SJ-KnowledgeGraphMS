...
function addAttributes() {
    ...
    if (attVids.length != 0) {
        ...
        for (var i = 0; i < attVids.length; i++) {
            ...
            var video_button = "<a href=\"" + vid.target + "\" target=\"_blank\"><button type=\"button\" class=\"btn btn-pic btn-info\">" + vid.source + (i+1) + "</button></a>&nbsp;&nbsp;";
...
function createGraphVisualization(data, relation_name) {
    ...
    for (var i = 0; i < results.length; i++) {
        ...
        //console.log(result.relation.toString());
